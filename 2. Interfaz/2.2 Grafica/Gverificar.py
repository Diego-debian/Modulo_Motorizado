...
# Botones con imagenes 
        ...
        btnSalir=Button(bicho, image=imgBoton1, command=Salir, height=100, width =250).place(x=20, y=380)
...
# Escritos en el texto
        w = Label(bicho, text="| GNU public license ... |", font=("Century Schoolbook L", 9)).place(x=480, y=165)
        ...
        w5 =Label (bicho, text = "| Iniciar ... |", font = ("Century Schoolbook L",10)).place(x=10,y=315)
        bicho.mainloop()  
