...
{\bf{Descriptores:}} Modulo motorizado, sensores infrarrojos, microcontrolador, modulo bluetooth. 
\end{abstract}
...
1.A. & 1.B \\ \hline
\end{tabular}
%\includegraphics[scale=0.35]{../Imágenes/agudo.eps}
