...
4.A. & 4.B. \\ \hline
\end{tabular}
\captionof{figure}{En la figura 4.A se observa las conexiones de los diodos tanto receptores como el emisor, conectanos al microcontrolador atmega328P-PU. En la figura 4.B esta  el montaje en protoboard.}
\label{fig:g4}
\end{Figure}
